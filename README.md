...
[![version](https://img.shields.io/badge/version-1.3.1-success)](https://github.com/brandonwie/jbook-ts-react)
...
In `packages/local-client`, simply run `npm run start `.</br> Navigate to port 3000 as usual.
